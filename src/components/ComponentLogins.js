...
<div class="menu-barra" id="menuBarra">
            ...
            <ul>
       <li ><a href="./login" className="Cabecera-a">Registro</a></li>   
         ...
         {/*  <-- Password input --> */}
          ...
          <div className="text-center text-lg-start mt-4 pt-2">
            <button onClick={()=>login()} type="button" className="btn btn-primary btn-lg"
              >Login</button>
            <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="./registers"
...
export default ComponentLogins