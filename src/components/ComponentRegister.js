...
<div className="container">
    <div className="main-body">
          ...
          <nav aria-label="breadcrumb" className="main-breadcrumb">
            ...
            <li ><a href="./" className="breadcrumb-item">Home\</a></li>   
            <li ><a href="./register" className="breadcrumb-item">Regitro\</a></li> 
            <li ><a href="./login" className="breadcrumb-item">Login</a></li>  
